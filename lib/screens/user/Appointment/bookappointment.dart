...
class BookAppointment extends StatelessWidget {
  BookAppointment({Key? key, required this.hospitalsn, this.hospitals}) : super(key: key);
  var fixedHieght;
  var fixedWidth;
                            ...
                            child: CustomButton(
                              Ontap: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => SelectClilinic(
                        ...
                        Container(
                          ...
                          GridView.builder(
                            ...
                            itemBuilder: (BuildContext context, index) {
                              var index1=hospitalsn.name== "hehia hospital"?0:1;
                            ...
                            itemCount: AppCubit()
                                .get(context)
                                .hospitalModel!.
                            hospitals![hospitalsn.name== "hehia hospital"?0:1].doctor!.length,
                          ):
                          Center(child: LinearProgressIndicator(color: Colors.blue,),)
                  ,
                        ):
                        Container(height: 80,
                          child: Center(child: Text("Staff is Empty Now")),
                        )
